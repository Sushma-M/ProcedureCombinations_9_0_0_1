...
public class ArticleTagsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ArticleTags editArticleTags(@RequestParam(value = "articleId", required = true) Integer articleId, @RequestParam(value = "tagId", required = true) Integer tagId, @RequestBody ArticleTags articleTags) throws EntityNotFoundException {
