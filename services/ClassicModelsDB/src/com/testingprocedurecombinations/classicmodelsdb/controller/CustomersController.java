...
import com.testingprocedurecombinations.classicmodelsdb.service.CustomersService;

/**
 * Controller object for domain model class Customers.
 * @see Customers
 */
@RestController("ClassicModelsDB.CustomersController")
@Api(value = "CustomersController", description = "Exposes APIs to work with Customers resource.")
@RequestMapping("/ClassicModelsDB/Customers")
