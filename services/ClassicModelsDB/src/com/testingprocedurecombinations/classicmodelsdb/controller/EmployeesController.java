...
import com.testingprocedurecombinations.classicmodelsdb.service.EmployeesService;

/**
 * Controller object for domain model class Employees.
 * @see Employees
 */
@RestController("ClassicModelsDB.EmployeesController")
@Api(value = "EmployeesController", description = "Exposes APIs to work with Employees resource.")
@RequestMapping("/ClassicModelsDB/Employees")
public class EmployeesController {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeesController.class);

    @Autowired
    @Qualifier("ClassicModelsDB.EmployeesService")
