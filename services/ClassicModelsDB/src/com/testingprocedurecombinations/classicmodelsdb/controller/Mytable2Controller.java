...
import com.testingprocedurecombinations.classicmodelsdb.Mytable2;
import com.testingprocedurecombinations.classicmodelsdb.Mytable2Id;
import com.testingprocedurecombinations.classicmodelsdb.service.Mytable2Service;

/**
 * Controller object for domain model class Mytable2.
 * @see Mytable2
 */
@RestController("ClassicModelsDB.Mytable2Controller")
@Api(value = "Mytable2Controller", description = "Exposes APIs to work with Mytable2 resource.")
@RequestMapping("/ClassicModelsDB/Mytable2")
public class Mytable2Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Mytable2Controller.class);

    @Autowired
    @Qualifier("ClassicModelsDB.Mytable2Service")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Mytable2 getMytable2(@RequestParam(value = "id", required = true) Integer col1, @RequestParam(value = "col1", required = true) Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Mytable2 editMytable2(@RequestParam(value = "id", required = true) Integer col1, @RequestParam(value = "col1", required = true) Integer id, @RequestBody Mytable2 mytable2) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMytable2(@RequestParam(value = "id", required = true) Integer col1, @RequestParam(value = "col1", required = true) Integer id) throws EntityNotFoundException {
        Mytable2Id mytable2Id = new Mytable2Id();
        mytable2Id.setCol1(col1);
        mytable2Id.setId(id);
