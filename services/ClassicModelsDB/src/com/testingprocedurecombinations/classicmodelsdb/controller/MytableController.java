...
public class MytableController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Mytable getMytable(@RequestParam(value = "columnA", required = true) Integer columnA, @RequestParam(value = "columnB", required = true) Integer columnB) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Mytable editMytable(@RequestParam(value = "columnA", required = true) Integer columnA, @RequestParam(value = "columnB", required = true) Integer columnB, @RequestBody Mytable mytable) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteMytable(@RequestParam(value = "columnA", required = true) Integer columnA, @RequestParam(value = "columnB", required = true) Integer columnB) throws EntityNotFoundException {
        MytableId mytableId = new MytableId();
        mytableId.setColumnA(columnA);
        mytableId.setColumnB(columnB);
