...
import com.testingprocedurecombinations.classicmodelsdb.Orderdetails;
import com.testingprocedurecombinations.classicmodelsdb.OrderdetailsId;
import com.testingprocedurecombinations.classicmodelsdb.service.OrderdetailsService;

/**
 * Controller object for domain model class Orderdetails.
 * @see Orderdetails
 */
@RestController("ClassicModelsDB.OrderdetailsController")
@Api(value = "OrderdetailsController", description = "Exposes APIs to work with Orderdetails resource.")
@RequestMapping("/ClassicModelsDB/Orderdetails")
public class OrderdetailsController {

    private static final Logger LOGGER = LoggerFactory.getLogger(OrderdetailsController.class);

    @Autowired
    @Qualifier("ClassicModelsDB.OrderdetailsService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Orderdetails editOrderdetails(@RequestParam(value = "orderNumber", required = true) Integer orderNumber, @RequestParam(value = "productCode", required = true) String productCode, @RequestBody Orderdetails orderdetails) throws EntityNotFoundException {
