...
import com.testingprocedurecombinations.classicmodelsdb.PaymentsId;
import com.testingprocedurecombinations.classicmodelsdb.service.PaymentsService;

/**
 * Controller object for domain model class Payments.
 * @see Payments
 */
@RestController("ClassicModelsDB.PaymentsController")
@Api(value = "PaymentsController", description = "Exposes APIs to work with Payments resource.")
@RequestMapping("/ClassicModelsDB/Payments")
