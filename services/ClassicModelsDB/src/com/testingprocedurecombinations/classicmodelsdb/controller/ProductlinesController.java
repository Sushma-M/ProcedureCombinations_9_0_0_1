...
import com.testingprocedurecombinations.classicmodelsdb.Productlines;
import com.testingprocedurecombinations.classicmodelsdb.service.ProductlinesService;

/**
 * Controller object for domain model class Productlines.
 * @see Productlines
 */
@RestController("ClassicModelsDB.ProductlinesController")
@Api(value = "ProductlinesController", description = "Exposes APIs to work with Productlines resource.")
@RequestMapping("/ClassicModelsDB/Productlines")
public class ProductlinesController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProductlinesController.class);

    @Autowired
    @Qualifier("ClassicModelsDB.ProductlinesService")
    ...
    public Productlines createProductlines(MultipartHttpServletRequest multipartHttpServletRequest) {
        Productlines productlines = WMMultipartUtils.toObject(multipartHttpServletRequest, Productlines.class, "ClassicModelsDB");
    ...
    public Productlines editProductlines(@PathVariable("id") String id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        Productlines newProductlines = WMMultipartUtils.toObject(multipartHttpServletRequest, Productlines.class, "ClassicModelsDB");
