...
import com.testingprocedurecombinations.classicmodelsdb.Employees;
 ...
 * @see Employees
 */
@Service("ClassicModelsDB.EmployeesService")
public class EmployeesServiceImpl implements EmployeesService {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeesServiceImpl.class);

    @Autowired
	@Qualifier("ClassicModelsDB.CustomersService")
	private CustomersService customersService;

    @Autowired
    @Qualifier("ClassicModelsDB.EmployeesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service ClassicModelsDB for table Employees to {} format", exportType);
