 ...
 * @see Mytable2
 */
@Service("ClassicModelsDB.Mytable2Service")
public class Mytable2ServiceImpl implements Mytable2Service {
    ...
    @Autowired
    @Qualifier("ClassicModelsDB.Mytable2Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service ClassicModelsDB for table Mytable2 to {} format", exportType);
