...
import com.testingprocedurecombinations.classicmodelsdb.Offices;
 ...
 * @see Offices
 */
@Service("ClassicModelsDB.OfficesService")
public class OfficesServiceImpl implements OfficesService {
    ...
    @Autowired
    @Qualifier("ClassicModelsDB.OfficesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service ClassicModelsDB for table Offices to {} format", exportType);
