 ...
 * @see Orderdetails
 */
@Service("ClassicModelsDB.OrderdetailsService")
public class OrderdetailsServiceImpl implements OrderdetailsService {
    ...
    @Autowired
    @Qualifier("ClassicModelsDB.OrderdetailsDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service ClassicModelsDB for table Orderdetails to {} format", exportType);
