 ...
 * @see Payments
 */
@Service("ClassicModelsDB.PaymentsService")
public class PaymentsServiceImpl implements PaymentsService {
    ...
    @Autowired
    @Qualifier("ClassicModelsDB.PaymentsDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service ClassicModelsDB for table Payments to {} format", exportType);
