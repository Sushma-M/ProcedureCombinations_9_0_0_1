 ...
 * @see Productlines
 */
@Service("ClassicModelsDB.ProductlinesService")
public class ProductlinesServiceImpl implements ProductlinesService {
    ...
    @Autowired
    @Qualifier("ClassicModelsDB.ProductlinesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service ClassicModelsDB for table Productlines to {} format", exportType);
