 ...
 * @see Table12
 */
@Service("ClassicModelsDB.Table12Service")
public class Table12ServiceImpl implements Table12Service {
    ...
    @Autowired
    @Qualifier("ClassicModelsDB.Table12Dao")
    ...
    @Transactional(readOnly = true, value = "ClassicModelsDBTransactionManager")
	@Override
	public Table12 findById(Integer table12Id) {
        LOGGER.debug("Finding Table12 by id: {}", table12Id);
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service ClassicModelsDB for table Table12 to {} format", exportType);
